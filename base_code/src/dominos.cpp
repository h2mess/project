...
//	  b2BodyDef a;
//	  a.position.Set(0,0);
//	  b2Body* b = (*m_world).CreateBody(&a);
//	  b2CircleShape acircle;
//	  acircle.m_p.Set(0,0);
//	  acircle.m_radius = 5;
//	  b2FixtureDef afixture;
//	  afixture.shape = &acircle;
//	  (*b).CreateFixture(&afixture);
//	  a.position.Set(10,0);
//	  b2Body* c = (*m_world).CreateBody(&a);
//	  (*c).CreateFixture(&afixture);
	  //upto here are for testing
//	b2BodyDef wheelDef;
//	wheelDef.type = b2_dynamicBody;
//	b2Body* wheelBody = (*m_world).CreateBody(&wheelDef);
//	b2CircleShape wheelCircle;
//	wheelCircle.m_p.Set(0,10);
//	wheelCircle.m_radius = wheelRadius;
...
//	(*wheelBody).CreateFixture(&wheelFixtureDef);
    ...
    b2Body* b1;  
    {
      ...
      b1->CreateFixture(&groundShape, 0.0f);
